...
//   return (
//     <div>
//         <div className='h-52 md:h-72 relative rounded-t-xl group' style={{backgroundImage: `url(${imgUrl})`,backgroundSize: 'cover'}}>
        
//           <div className='overlay md:flex items-center justify-center absolute top-0 left-0 w-full h-full bg-black/40 bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500'>
//             <Link
//                 href={gitUrl}
